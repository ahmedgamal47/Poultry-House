          ...
          <div class="col-md-12">
            <div class="card login-tabs">
              <div class="login-tab-content">
                <h4>برجاء كتابه بريدك الالكترونى المسجل لدينا و سوف تصلك رسالة بريدية لتغيير كلمة المرور</h4>
                <br>
                @if (session('status'))
                  ...
                  <span class="input-group-btn">
                    <i class="fas fa-user"></i>
                      ...
                      <input type="email" class="form-control" name="email"
                             placeholder="البريد الالكترونى *" value="{{ $email ?? old('email') }}" autocomplete="email"
                             required autofocus>
                    </div>
                  </div>
                  <div class="login-div-login-btn-div">
                    <button type="submit" class="btn btn-default login-div-login-btn">طلب تغيير كلمة المرور</button>
                  </div>
                </form>
              </div>
            </div>
